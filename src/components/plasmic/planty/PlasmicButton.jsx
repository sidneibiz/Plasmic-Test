...
import sty from "./PlasmicButton.module.css"; // plasmic-import: IHFKkmwx8NvkPc/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 3o0AKvfnbv1ifG/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__n9H3V)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xhT2Z)}
                role={"img"}
              />
            ),
